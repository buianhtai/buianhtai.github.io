...
<Flowchart
  ...
  nodes={[
    { id: "start", label: "Pick your limiter",        shape: "oval",    color: "teal",  sub: "shared across all instances" },
    { id: "exact", label: "Exact counts required?",   shape: "diamond",                 sub: "billing, audit, SLA enforcement" },
    { id: "vol",   label: "High request volume?",     shape: "diamond",                 sub: "memory scales with traffic" },
    ...
    { id: "tok",   label: "Token bucket",             shape: "rect",    color: "green", sub: "capacity + refill rate" },
...
<StateMachine
  ...
  states={[
    { id: "logged",  label: "In the log",   sub: "XADD — immutable entry",            row: 1, col: 1 },
    { id: "pending", label: "Pending (PEL)",sub: "delivered, awaiting XACK",          row: 1, col: 2 },
    { id: "acked",   label: "Acked",        sub: "processed; group cursor advances",  row: 1, col: 3 },
...
<SequenceDiagram
  ...
  actors={[
    { label: "Producer", color: "teal" },
    { label: "Redis Stream", color: "blue" },
    { label: "Worker A", color: "violet" },
    { label: "Worker B", color: "green" },
  ]}
  messages={[
