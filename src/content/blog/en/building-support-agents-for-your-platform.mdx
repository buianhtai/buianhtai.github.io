---
title: "Building Support Agents for Your Platform"
description: "Support volume for an API platform spans how-to questions, account issues, and deep technical errors with traceIds. Here is how enterprises build multi-agent support systems that cover it all — architecture, knowledge pipelines, deployment, determinism, scaling, cost, and the open source to assemble it from."
heroImage: "/og/support-agents-og.png"
pubDate: 2026-08-24
...
<Flowchart
  ...
  nodes={[
    { id: "cust",    label: "Customer ticket",      shape: "oval",   color: "teal",   icon: "lucide:message-circle", sub: "question · account issue · error + traceId" },
    ...
    { id: "faq",     label: "How-to agent",         shape: "rect",   color: "violet", icon: "lucide:compass",        sub: "API & UI usage — answers from KB" },
    { id: "account", label: "Account agent",        shape: "rect",   color: "green",  icon: "lucide:credit-card",    sub: "billing, plans, access — scoped reads only" },
  ...
  edges={[
    { from: "cust",   to: "triage" },
    { from: "triage", to: "faq",     label: "usage questions — most volume" },
    { from: "triage", to: "account", label: "account / billing intent" },
    { from: "triage", to: "docs",    label: "technical lane" },
    { from: "triage", to: "obs",     label: "if traceId present" },
    { from: "triage", to: "known",   label: "delegation" },
    { from: "faq",    to: "reply",   label: "grounded answer" },
    { from: "account",to: "reply",   label: "self-service safe" },
    { from: "docs",   to: "synth" },
    { from: "obs",    to: "synth" },
    { from: "known",  to: "synth" },
...
<ArchDiagram
  title="support agent platform — containers view"
  zones={[
    { id: "edge",      label: "Channels",        color: "teal" },
    { id: "platform",  label: "Agent platform",  color: "violet" },
    { id: "cap",       label: "Capability plane", color: "amber" },
    { id: "state",     label: "State",           color: "green" },
  ]}
  nodes={[
    { id: "ch",     label: "Customer channels",   sub: "portal · email · chat widget",     zone: "edge",     row: 1, col: 1 },
    { id: "api",    label: "Agent API service",   sub: "sync triage endpoint",             zone: "platform", row: 1, col: 1 },
    { id: "queue",  label: "Investigation queue", sub: "async jobs, tenant caps",          zone: "platform", row: 1, col: 2 },
    { id: "rt",     label: "Runtime workers",     sub: "stateless pods, framework inside", zone: "platform", row: 2, col: 1 },
    { id: "gw",     label: "Provider gateway",    sub: "rate limits · cost · fallback",    zone: "platform", row: 2, col: 2 },
    { id: "mcp",    label: "MCP servers",         sub: "logs · traces · docs · tickets",   zone: "cap",      row: 1, col: 1 },
    { id: "kestra", label: "Kestra",              sub: "KB re-index · eval sweeps",        zone: "cap",      row: 1, col: 2 },
    { id: "temp",   label: "Temporal",            sub: "durable investigation runs",       zone: "cap",      row: 2, col: 1 },
    { id: "cam",    label: "Camunda",             sub: "escalation processes",             zone: "cap",      row: 2, col: 2 },
    { id: "pg",     label: "Postgres",            sub: "checkpoints · tickets · evals",    zone: "state",    row: 1, col: 1 },
    { id: "redis",  label: "Redis",               sub: "sessions · retrieval caches",      zone: "state",    row: 1, col: 2 },
    { id: "vec",    label: "Vector index",        sub: "pgvector / Qdrant",                zone: "state",    row: 2, col: 1 },
  ]}
  edges={[
    { from: "ch",      to: "api",    type: "solid" },
    { from: "api",     to: "queue",  label: "long work", type: "solid" },
    { from: "queue",   to: "rt",     type: "solid" },
    { from: "rt",      to: "mcp",    label: "tool calls", type: "solid" },
    { from: "rt",      to: "gw",     label: "model calls", type: "dashed" },
    { from: "rt",      to: "pg",     type: "solid" },
    { from: "rt",      to: "redis",  type: "solid" },
    { from: "temp",    to: "rt",     label: "supervise", type: "dashed" },
    { from: "cam",     to: "rt",     label: "human gates", type: "dashed" },
    { from: "kestra",  to: "vec",    label: "re-index", type: "dashed" },
  ]}
  caption="Plug-and-play boundaries: model providers live behind the gateway, capabilities are MCP servers you add or remove per lane, workflow engines attach from the side without entering the reasoning path, and every store is rebuildable except Postgres."
/>
