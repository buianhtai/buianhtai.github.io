...
<DataTable
  ...
  rows={[
    ...
    { "Framework": "CrewAI", "Model": "Role-based crews", "Strengths": "Fastest prototyping; native MCP + A2A; visual editor; huge community", "Watch out for": "~8–35% token overhead from role prompts (one 2026 benchmark's midpoint); harder to debug complex flows" },
