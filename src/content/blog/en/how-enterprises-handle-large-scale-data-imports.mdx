...
<StateMachine
  ...
  states={[
    { id: "pending",    label: "Pending",    sub: "accepted, queued",              row: 1, col: 1 },
    { id: "running",    label: "Running",    sub: "progress lives in metadata",    row: 1, col: 2 },
    { id: "completed",  label: "Completed",  sub: "result / presigned download",   row: 1, col: 3 },
    { id: "failed",     label: "Failed",     sub: "error + partial report",        row: 2, col: 3 },
...
<Flowchart
  ...
  nodes={[
    { id: "refs",     label: "Depth 0 — References",   shape: "rect", color: "teal",   sub: "lookup tables, no deps" },
    { id: "parents",  label: "Depth 1 — Parents",      shape: "rect",                  sub: "parallel within layer" },
    { id: "children", label: "Depth 2 — Children",     shape: "rect",                  sub: "FK → resolved parents" },
    { id: "details",  label: "Depth 3 — Details",      shape: "rect", color: "violet", sub: "grandchild / line rows" },
...
<Flowchart
  ...
  nodes={[
    { id: "arrive",   label: "Request + Idempotency-Key", shape: "oval",   color: "teal",   sub: "one key per logical operation" },
    { id: "claim",    label: "Atomic claim won?",         shape: "diamond",                 sub: "INSERT ... ON CONFLICT — never check-then-insert" },
    { id: "exec",     label: "Execute handler",           shape: "rect",                    sub: "store response + hash on the key row" },
    { id: "replay",   label: "Replay stored response",    shape: "rect",   color: "teal",   sub: "verbatim — even if it was an error" },
    { id: "progress", label: "409 in progress",           shape: "rect",   color: "amber",  sub: "client retries later; don't block" },
    { id: "reject",   label: "422 reject",                shape: "rect",   color: "rose",   sub: "same key, different payload = client bug" },
  ]}
  edges={[
