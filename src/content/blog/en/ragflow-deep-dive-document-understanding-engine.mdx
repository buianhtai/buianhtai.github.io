---
title: "RAGFlow Deep-Dive: The Document-Understanding RAG Engine"
description: "RAGFlow bets that retrieval quality is decided before embeddings — at parse time. A close look at its DeepDoc pipeline, template chunking, orchestrable ingestion graphs, honest pain points from production issues, and when it's the right engine."
pubDate: 2026-08-24
tags: ["rag", "ragflow", "open-source", "knowledge-base", "self-hosted"]
lang: "en"
category: "ai"
---
...
<Flowchart
  title="RAGFlow ingestion — parsing decides everything downstream"
  nodes={[
    { id: "in",    label: "Documents",        shape: "oval",   color: "teal",   icon: "lucide:file-text",     sub: "PDF · DOCX · scans · slides · images" },
    { id: "parse", label: "Parser",           shape: "rect",   color: "violet", icon: "lucide:scan-text",     sub: "DeepDoc (OCR·TSR·DLR) | MinerU | Docling | naive" },
    { id: "chunk", label: "Chunker",          shape: "rect",   color: "blue",   icon: "lucide:scissors",      sub: "Token (512 default) or Title-based slicing" },
    { id: "xfm",   label: "Transformer",      shape: "rect",   color: "amber",  icon: "lucide:wand-sparkles", sub: "LLM enrichment: summaries · keywords · structure" },
    { id: "idx",   label: "Indexer",          shape: "rect",   color: "green",  icon: "lucide:database",      sub: "full-text + vector, dataset's embedding model" },
    { id: "ret",   label: "Multi-recall",     shape: "oval",   color: "teal",   icon: "lucide:search-check",  sub: "fused re-ranking across chunks" },
  ]}
  edges={[
    { from: "in",    to: "parse" },
    { from: "parse", to: "chunk", label: "semi-structured content" },
    { from: "chunk", to: "xfm",   label: "bridge the semantic gap" },
    { from: "xfm",   to: "idx" },
    { from: "idx",   to: "ret",   label: "query time" },
  ]}
/>
...
<DataTable
  caption="Built-in chunking templates (selection)"
  accent="violet"
  headers={["Template", "Designed for", "Formats"]}
  rows={[
    { "Template": "General", "Designed for": "Consecutive token-based chunking (default 512 tokens)", "Formats": "MD, DOCX, XLSX, PPT, PDF, TXT, images, CSV, JSON, EML, HTML" },
    { "Template": "Q&A", "Designed for": "Question-answer pair extraction", "Formats": "XLSX, CSV/TXT" },
    { "Template": "Paper / Book / Laws / Manual", "Designed for": "Structured long-form documents", "Formats": "PDF, DOCX" },
    { "Template": "Presentation", "Designed for": "Slide decks", "Formats": "PDF, PPTX" },
    { "Template": "Table", "Designed for": "Tabular data via TSI technology", "Formats": "XLSX, CSV/TXT" },
    { "Template": "One", "Designed for": "Entire document as a single chunk", "Formats": "DOCX, XLSX, PDF, TXT" },
    { "Template": "Picture", "Designed for": "Image understanding", "Formats": "JPEG, PNG, TIF, GIF" },
    { "Template": "Tag", "Designed for": "Dataset as a tag set feeding others", "Formats": "XLSX, CSV/TXT" },
  ]}
/>
...
<Callout color="teal">
The transferable lesson regardless of engine: retrieval quality is decided at ingestion. Budget parsing time, choose chunking templates per document genre, inspect your chunks visually, and treat oversized-chunk failures as signals about document structure — not as bugs to suppress.
</Callout>
